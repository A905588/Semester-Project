...
int main() { 
 ...
 detail[0]={"Lorina","0557196527","tyga@uenr.edu",400,3.99,"UEB322909"}; 
 detail[1]={"Tygapufa","0543210543","pufa@uenr.edu",100,4.0,"UEB3212922"}; 
 detail[2]={"Dr. Appiahene","0123456789","HOD@uenr.edu",900,7.0},"UAB4245254"; 
 detail[3]={"Freshman","9876543210","tunchi@uenr.edu",100,2.9,"UAS1332442"}; 
